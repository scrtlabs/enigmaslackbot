...
var RESPONSES = {
    ...
    'sec':          "According to the legal advice from our excellent lawyers, ENG is a utility token and it does not " +
                    ...
                    "regulatory bodies.",
    'whitelist':    "Our whitelist, which guarantees access to our crowdsale, is only open for members of the Enigma community - those of you who " +
                    "participate in either our Slack or Telegram groups. The whitelist application can be found here: https://goo.gl/forms/Xgx4sz3emvaGewkr1.\n\n" +
                    "If you receive any email confirmation after submitting your whitelist form, including from Google forms, you have been whitelisted " +
                    "and there is nothing else you need to do for now.\n\n" +
                    "The whitelist will close at *11:59PM Pacific Time, Monday, August 21.* Everyone signing up after this date will be _waitlisted_ for our whitelist.",
