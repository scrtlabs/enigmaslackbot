...
var RESPONSES = {
    ...
    'presale':      'The presale is ongoing. Minimum buy-in is USD100K or equivalent in crypto. You must be an accredited investor to participate in the ' + 
                    'pre-sale. We do the pre-sale through a legal doc that is called a SAFT. After filling earlier tranches, there are no further discounts for ' +
                    'presale participants. We can accept fiat, BTC, or ETH.\n\n' +
                    'If you are interested in contributing in the pre-sale please fill out the following form: https://goo.gl/forms/iLecWxhn3SqJdyIB3',
